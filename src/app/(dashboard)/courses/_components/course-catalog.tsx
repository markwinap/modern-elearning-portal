  ...
  return (
    <div>
      ...
      {courses.length === 0 && !isFetching ? (
        <EmptyState icon={<SearchOutlined />} title="No courses found" />
      ) : (
        <>
                ...
                <Col key={course.id} xs={24} sm={12} lg={8} xl={6}>
                  ...
                  >
                    ...
                    <div style={{ marginTop: 8, marginBottom: 8 }}>
                      <Tag
                        color={
                          course.locationType === "online" ? "blue" : "orange"
                        }
                      >
                      ...
                      {course.locationType === "onsite" &&
                        course.siteLocation && (
                          ...
                          >
                            <EnvironmentOutlined /> {course.siteLocation}
                          </Typography.Text>
                        )}
                    </div>
                    {course.description && (
